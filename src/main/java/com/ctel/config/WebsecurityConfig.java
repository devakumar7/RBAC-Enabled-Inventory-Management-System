...
//			InvalidUserAuthEntryPoint authenticationEntryPoint, SecurityFilter securityFilter) {
//		super();
...
//				authorizeRequests().antMatchers("/saveCust", "/login", "/updateCust/{cid}", "/viewCust/{cid}",
//						"/viewCusts", "/deleteCust/{cid}")
//				.permitAll()
//
////				 authority required
//
